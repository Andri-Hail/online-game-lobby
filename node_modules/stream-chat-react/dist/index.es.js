import React, { useState, useRef, useCallback, useEffect, useContext, useMemo, Suspense, useReducer, useLayoutEffect, PureComponent } from 'react';
...
var MessageTeamWithContext = function (props) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    var addNotification = props.addNotification, _l = props.Avatar, Avatar$1 = _l === void 0 ? Avatar : _l, Attachment = props.Attachment, channel = props.channel, propChannelConfig = props.channelConfig, clearEditingState = props.clearEditingState, editing = props.editing, _m = props.EditMessageInput, EditMessageInput = _m === void 0 ? EditMessageForm : _m, formatDate = props.formatDate, getFlagMessageErrorNotification = props.getFlagMessageErrorNotification, getFlagMessageSuccessNotification = props.getFlagMessageSuccessNotification, getMessageActions = props.getMessageActions, getMuteUserErrorNotification = props.getMuteUserErrorNotification, getMuteUserSuccessNotification = props.getMuteUserSuccessNotification, groupStyles = props.groupStyles, handleAction = props.handleAction, handleEdit = props.handleEdit, handleFlag = props.handleFlag, handleDelete = props.handleDelete, handleOpenThread = props.handleOpenThread, handleMute = props.handleMute, handlePin = props.handlePin, handleReaction = props.handleReaction, handleRetry = props.handleRetry, initialMessage = props.initialMessage, isMyMessage = props.isMyMessage, isReactionEnabled = props.isReactionEnabled, lastReceivedId = props.lastReceivedId, message = props.message, _o = props.MessageDeleted, MessageDeleted$1 = _o === void 0 ? MessageDeleted : _o, messageListRect = props.messageListRect, messageWrapperRef = props.messageWrapperRef, onMentionsClickMessage = props.onMentionsClickMessage, onMentionsHoverMessage = props.onMentionsHoverMessage, onReactionListClick = props.onReactionListClick, propOnUserClick = props.onUserClick, propOnUserHover = props.onUserHover, _p = props.PinIndicator, PinIndicator$1 = _p === void 0 ? PinIndicator : _p, _q = props.ReactionsList, ReactionsList = _q === void 0 ? SimpleReactionsList : _q, _r = props.ReactionSelector, ReactionSelector$1 = _r === void 0 ? ReactionSelector : _r, reactionSelectorRef = props.reactionSelectorRef, readBy = props.readBy, _s = props.renderText, renderText$1 = _s === void 0 ? renderText : _s, showDetailedReactions = props.showDetailedReactions, setEditingState = props.setEditingState, threadList = props.threadList, unsafeHTML = props.unsafeHTML;
    var _t = useTranslationContext(), t = _t.t, userLanguage = _t.userLanguage;
...
var Cancel$8="Cancel";var Close$8="Close";var Delete$8="Delete";var Delivered$8="Delivered";var Flag$8="Flag";var Mute$8="Mute";var New$8="New";var Pin$8="Pin";var Send$8="Send";var Thread$9="Thread";var Unmute$8="Unmute";var Unpin$8="Unpin";var live$8="live";var enTranslations = {"1 reply":"1 reply","Attach files":"Attach files",Cancel:Cancel$8,"Channel Missing":"Channel Missing",Close:Close$8,"Close emoji picker":"Close emoji picker","Commands matching":"Commands matching","Connection failure, reconnecting now...":"Connection failure, reconnecting now...",Delete:Delete$8,Delivered:Delivered$8,"Edit Message":"Edit Message","Emoji matching":"Emoji matching","Empty message...":"Empty message...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Error adding flag: Either the flag already exist or there is issue with network connection ...","Error connecting to chat, refresh the page to try again.":"Error connecting to chat, refresh the page to try again.","Error muting a user ...":"Error muting a user ...","Error pinning message":"Error pinning message","Error removing message pin":"Error removing message pin","Error unmuting a user ...":"Error unmuting a user ...","Error · Unsent":"Error · Unsent","Error: {{ errorMessage }}":"Error: {{ errorMessage }}",Flag:Flag$8,"Message Failed · Click to try again":"Message Failed · Click to try again","Message Failed · Unauthorized":"Message Failed · Unauthorized","Message deleted":"Message deleted","Message has been successfully flagged":"Message has been successfully flagged","Message pinned":"Message pinned",Mute:Mute$8,New:New$8,"New Messages!":"New Messages!","Nothing yet...":"Nothing yet...","Only visible to you":"Only visible to you","Open emoji picker":"Open emoji picker","People matching":"People matching","Pick your emoji":"Pick your emoji",Pin:Pin$8,"Pinned by":"Pinned by",Send:Send$8,"Sending...":"Sending...","Start of a new thread":"Start of a new thread","This message was deleted...":"This message was deleted...",Thread:Thread$9,"Type your message":"Type your message",Unmute:Unmute$8,Unpin:Unpin$8,"You have no channels currently":"You have no channels currently","You've reached the maximum number of files":"You've reached the maximum number of files",live:live$8,"this content could not be displayed":"this content could not be displayed","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} and {{ lastUser }} are typing...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} and {{ moreCount }} more","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }}, and {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} and {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} and {{ secondUser }} are typing...","{{ imageCount }} more":"{{ imageCount }} more","{{ memberCount }} members":"{{ memberCount }} members","{{ replyCount }} replies":"{{ replyCount }} replies","{{ user }} has been muted":"{{ user }} has been muted","{{ user }} has been unmuted":"{{ user }} has been unmuted","{{ user }} is typing...":"{{ user }} is typing...","{{ watcherCount }} online":"{{ watcherCount }} online","🏙 Attachment...":"🏙 Attachment..."};

var Cancel$7="Cancelar";var Close$7="Cerca";var Delete$7="Borrar";var Delivered$7="Entregado";var Flag$7="Bandera";var Mute$7="Mudo";var New$7="Nuevo";var Pin$7="Alfiler";var Send$7="Enviar";var Thread$8="Hilo";var Unmute$7="Activar sonido";var Unpin$7="Desprender";var live$7="En Vivo";var esTranslations = {"1 reply":"1 respuesta","Attach files":"Adjuntar archivos",Cancel:Cancel$7,"Channel Missing":"Falta canal",Close:Close$7,"Close emoji picker":"Cerrar el selector de emojis","Commands matching":"Coincidencia de comandos","Connection failure, reconnecting now...":"Fallo de conexión, reconectando ahora ...",Delete:Delete$7,Delivered:Delivered$7,"Edit Message":"Editar mensaje","Emoji matching":"Coincidencia de emoji","Empty message...":"Mensaje vacío ...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Error al agregar la bandera: la bandera ya existe o hay un problema con la conexión de red ...","Error connecting to chat, refresh the page to try again.":"Error al conectarse al chat, actualice la página para volver a intentarlo.","Error muting a user ...":"Error al silenciar a un usuario ...","Error pinning message":"Mensaje de error al fijar","Error removing message pin":"Error al quitar el pin del mensaje","Error unmuting a user ...":"Error al activar el silencio de un usuario ...","Error · Unsent":"Error · No enviado","Error: {{ errorMessage }}":"Error: {{mensaje de error}}",Flag:Flag$7,"Message Failed · Click to try again":"Mensaje fallido · Haga clic para volver a intentarlo","Message Failed · Unauthorized":"Mensaje fallido · No autorizado","Message deleted":"Mensaje borrado","Message has been successfully flagged":"El mensaje se marcó correctamente","Message pinned":"Mensaje fijado",Mute:Mute$7,New:New$7,"New Messages!":"¡Nuevos mensajes!","Nothing yet...":"Nada aún...","Only visible to you":"Solo visible para ti","Open emoji picker":"Selector de emoji abierto","People matching":"Personas que coinciden","Pick your emoji":"Elige tu emoji",Pin:Pin$7,"Pinned by":"Fijado por",Send:Send$7,"Sending...":"Enviando...","Start of a new thread":"Inicio de un nuevo hilo","This message was deleted...":"Este mensaje fue eliminado ...",Thread:Thread$8,"Type your message":"Escribe tu mensaje",Unmute:Unmute$7,Unpin:Unpin$7,"You have no channels currently":"Actualmente no tienes canales","You've reached the maximum number of files":"Has alcanzado el número máximo de archivos",live:live$7,"this content could not be displayed":"este contenido no se pudo mostrar","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{commaSeparatedUsers}} y {{lastUser}} están escribiendo ...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{commaSeparatedUsers}} y {{moreCount}} más","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{commaSeparatedUsers}} y {{lastUser}}","{{ firstUser }} and {{ secondUser }}":"{{firstUser}} y {{secondUser}}","{{ firstUser }} and {{ secondUser }} are typing...":"{{firstUser}} y {{secondUser}} están escribiendo ...","{{ imageCount }} more":"{{imageCount}} más","{{ memberCount }} members":"{{memberCount}} miembros","{{ replyCount }} replies":"{{replyCount}} respuestas","{{ user }} has been muted":"{{user}} ha sido silenciado","{{ user }} has been unmuted":"{{usuario}} ha sido silenciado","{{ user }} is typing...":"{{user}} está escribiendo ...","{{ watcherCount }} online":"{{watcherCount}} en línea","🏙 Attachment...":"🏙 Adjunto..."};

var Cancel$6="Annuleer";var Close$6="Sluit";var Delete$6="Verwijder";var Delivered$6="Afgeleverd";var Flag$6="Markeer";var Mute$6="Mute";var New$6="Nieuwe";var Pin$6="Pin";var Send$6="Verstuur";var Thread$7="Draadje";var Unmute$6="Unmute";var Unpin$6="Losmaken";var live$6="live";var nlTranslations = {"1 reply":"1 antwoord","Attach files":"Bijlage toevoegen",Cancel:Cancel$6,"Channel Missing":"Kanaal niet gevonden",Close:Close$6,"Close emoji picker":"Sluit de emoji-kiezer","Commands matching":"Bijpassende opdrachten","Connection failure, reconnecting now...":"Probleem met de verbinding, opnieuw verbinding maken...",Delete:Delete$6,Delivered:Delivered$6,"Edit Message":"Pas bericht aan","Emoji matching":"Emoji-overeenkomsten","Empty message...":"Leeg bericht...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Fout bij het markeren: of het bericht is al gemarkeerd of er is een probleem met de netwerk verbinding","Error connecting to chat, refresh the page to try again.":"Fout bij het verbinden, ververs de pagina om nogmaals te proberen","Error muting a user ...":"Fout bij het muten van de gebruiker","Error pinning message":"Fout bij vastzetten van bericht","Error removing message pin":"Fout bij verwijderen van berichtpin","Error unmuting a user ...":"Fout bij het unmuten van de gebruiker","Error · Unsent":"Error: · niet verzonden","Error: {{ errorMessage }}":"Error: {{ errorMessage }}",Flag:Flag$6,"Message Failed · Click to try again":"Bericht mislukt, klik om het nogmaals te proberen","Message Failed · Unauthorized":"Bericht mislukt, ongeautoriseerd","Message deleted":"Bericht verwijderd","Message has been successfully flagged":"Bericht is succesvol gemarkeerd","Message pinned":"Bericht vastgezet",Mute:Mute$6,New:New$6,"New Messages!":"Nieuwe Berichten!","Nothing yet...":"Nog niets ...","Only visible to you":"Alleen zichtbaar voor jou","Open emoji picker":"Open emojipicker","People matching":"Mensen die matchen","Pick your emoji":"Kies je emoji",Pin:Pin$6,"Pinned by":"Vastgemaakt door",Send:Send$6,"Sending...":"Aan het verzenden...","Start of a new thread":"Begin van een nieuwe draadje","This message was deleted...":"Dit bericht was verwijderd",Thread:Thread$7,"Type your message":"Type je bericht",Unmute:Unmute$6,Unpin:Unpin$6,"You have no channels currently":"Er zijn geen chats beschikbaar","You've reached the maximum number of files":"Je hebt het maximale aantal bestanden bereikt",live:live$6,"this content could not be displayed":"Deze inhoud kan niet weergegeven worden","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} en {{ lastUser }} zijn aan het typen ...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} en {{ moreCount }} meer","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }} en {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} en {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} en {{ secondUser }} zijn aan het typen ...","{{ imageCount }} more":"+{{ imageCount }}","{{ memberCount }} members":"{{ memberCount }} deelnemers","{{ replyCount }} replies":"{{ replyCount }} antwoorden","{{ user }} has been muted":"{{ user }} is muted","{{ user }} has been unmuted":"{{ user }} is unmuted","{{ user }} is typing...":"{{ user }} is aan het typen...","{{ watcherCount }} online":"{{ watcherCount }} online","🏙 Attachment...":"🏙 Bijlage..."};

var Cancel$5="Отмена";var Close$5="Закрыть";var Delete$5="Удалить";var Delivered$5="Отправлено";var Flag$5="Пожаловаться";var Mute$5="Отключить уведомления";var New$5="Новые";var Pin$5="Штырь";var Send$5="Отправить";var Thread$6="Ветка";var Unmute$5="Включить уведомления";var Unpin$5="Открепить";var live$5="В прямом эфире";var ruTranslations = {"1 reply":"1 ответ","Attach files":"Прикрепить файлы",Cancel:Cancel$5,"Channel Missing":"Канал не найден",Close:Close$5,"Close emoji picker":"Закрыть окно выбора смайлов","Commands matching":"Соответствие команд","Connection failure, reconnecting now...":"Ошибка соединения, переподключение...",Delete:Delete$5,Delivered:Delivered$5,"Edit Message":"Редактировать сообщение","Emoji matching":"Соответствие эмодзи","Empty message...":"Пустое сообщение...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Ошибка добавления флага: флаг уже существует или ошибка подключения к сети...","Error connecting to chat, refresh the page to try again.":"Ошибка подключения к чату, обновите страницу чтобы попробовать снова.","Error muting a user ...":"Ошибка отключения уведомлений от пользователя...","Error pinning message":"Сообщение об ошибке при закреплении","Error removing message pin":"Ошибка при удалении булавки сообщения","Error unmuting a user ...":"Ошибка включения уведомлений...","Error · Unsent":"Ошибка · Не отправлено","Error: {{ errorMessage }}":"Ошибка: {{ errorMessage }}",Flag:Flag$5,"Message Failed · Click to try again":"Ошибка отправки сообщения · Нажмите чтобы повторить","Message Failed · Unauthorized":"Ошибка отправки сообщения · Неавторизованный","Message deleted":"Сообщение удалено","Message has been successfully flagged":"Жалоба на сообщение была принята","Message pinned":"Сообщение закреплено",Mute:Mute$5,New:New$5,"New Messages!":"Новые сообщения!","Nothing yet...":"Пока ничего нет...","Only visible to you":"Только видно для вас","Open emoji picker":"Выбрать emoji","People matching":"Соответствующие люди","Pick your emoji":"Выберите свой emoji",Pin:Pin$5,"Pinned by":"Закреплено",Send:Send$5,"Sending...":"Отправка...","Start of a new thread":"Начало новой ветки","This message was deleted...":"Сообщение было удалено...",Thread:Thread$6,"Type your message":"Ваше сообщение",Unmute:Unmute$5,Unpin:Unpin$5,"You have no channels currently":"У вас нет каналов в данный момент","You've reached the maximum number of files":"Вы достигли максимального количества файлов",live:live$5,"this content could not be displayed":"Этот контент не может быть отображен в данный момент","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} и {{ lastUser }} пишут...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} и {{ moreCount }} еще","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }} и {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} и {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} и {{ secondUser }} пишут...","{{ imageCount }} more":"Ещё {{ imageCount }}","{{ memberCount }} members":"{{ memberCount }} члены","{{ replyCount }} replies":"{{ replyCount }} ответов","{{ user }} has been muted":"Вы отписались от уведомлений от {{ user }}","{{ user }} has been unmuted":"Уведомления от {{ user }} были включены","{{ user }} is typing...":"{{ user }} пишет...","{{ watcherCount }} online":"{{ watcherCount }} в сети","🏙 Attachment...":"🏙 Вложение..."};

var Cancel$4="İptal";var Close$4="Kapat";var Delete$4="Sil";var Delivered$4="İletildi";var Flag$4="Bayrak";var Mute$4="Sessiz";var New$4="Yeni";var Pin$4="Toplu iğne";var Send$4="Gönder";var Thread$5="Konu";var Unmute$4="Sesini aç";var Unpin$4="Sabitlemeyi kaldır";var live$4="canlı";var trTranslations = {"1 reply":"1 cevap","Attach files":"Dosya ekle",Cancel:Cancel$4,"Channel Missing":"Kanal bulunamıyor",Close:Close$4,"Close emoji picker":"Emoji seçiciyi kapat","Commands matching":"Eşleşen komutlar","Connection failure, reconnecting now...":"Bağlantı hatası, tekrar bağlanılıyor...",Delete:Delete$4,Delivered:Delivered$4,"Edit Message":"Mesajı Düzenle","Emoji matching":"Emoji eşleştirme","Empty message...":"Boş mesaj...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Bayraklama hatası: Bayrak zaten var veya bağlantı sorunlu","Error connecting to chat, refresh the page to try again.":"Bağlantı hatası, sayfayı yenileyip tekrar deneyin.","Error muting a user ...":"Kullanıcıyı sessize alırken hata oluştu ...","Error pinning message":"Mesaj sabitlenirken hata oluştu","Error removing message pin":"Mesaj PIN'i kaldırılırken hata oluştu","Error unmuting a user ...":"Kullanıcının sesini açarken hata oluştu ...","Error · Unsent":"Hata · Gönderilemedi","Error: {{ errorMessage }}":"Hata: {{ errorMessage }}",Flag:Flag$4,"Message Failed · Click to try again":"Mesaj Başarısız · Tekrar denemek için tıklayın","Message Failed · Unauthorized":"Mesaj Başarısız · Yetkisiz","Message deleted":"Mesaj silindi","Message has been successfully flagged":"Mesaj başarıyla bayraklandı","Message pinned":"Mesaj sabitlendi",Mute:Mute$4,New:New$4,"New Messages!":"Yeni Mesajlar!","Nothing yet...":"Şimdilik hiçbir şey...","Only visible to you":"Sadece size görünür","Open emoji picker":"Emoji klavyesini aç","People matching":"Eşleşen kişiler","Pick your emoji":"Emoji seçin",Pin:Pin$4,"Pinned by":"Sabitleyen",Send:Send$4,"Sending...":"Gönderiliyor...","Start of a new thread":"Yeni konunun başı","This message was deleted...":"Bu mesaj silindi",Thread:Thread$5,"Type your message":"Mesajınızı yazın",Unmute:Unmute$4,Unpin:Unpin$4,"You have no channels currently":"Henüz kanalınız yok","You've reached the maximum number of files":"Maksimum dosya sayısına ulaştınız",live:live$4,"this content could not be displayed":"bu içerik gösterilemiyor","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{ commaSeparatedUsers }} ve {{ lastUser }} yazıyor...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{ commaSeparatedUsers }} ve {{ moreCount }} daha","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{ commaSeparatedUsers }}, ve {{ lastUser }}","{{ firstUser }} and {{ secondUser }}":"{{ firstUser }} ve {{ secondUser }}","{{ firstUser }} and {{ secondUser }} are typing...":"{{ firstUser }} ve {{ secondUser }} yazıyor...","{{ imageCount }} more":"{{ imageCount }} adet daha","{{ memberCount }} members":"{{ memberCount }} üyeler","{{ replyCount }} replies":"{{ replyCount }} cevaplar","{{ user }} has been muted":"{{ user }} sessize alındı","{{ user }} has been unmuted":"{{ user }} sesi açıldı","{{ user }} is typing...":"{{ user }} yazıyor...","{{ watcherCount }} online":"{{ watcherCount }} çevrimiçi","🏙 Attachment...":"🏙 Ek..."};

var Cancel$3="Cancelar";var Close$3="Perto";var Delete$3="Excluir";var Delivered$3="Entregue";var Flag$3="Bandeira";var Mute$3="Mudo";var New$3="Novo";var Pin$3="Alfinete";var Send$3="Mandar";var Thread$4="Fio";var Unmute$3="Com som";var Unpin$3="Liberar";var live$3="viver";var ptTranslations = {"1 reply":"1 resposta","Attach files":"Anexar arquivos",Cancel:Cancel$3,"Channel Missing":"Canal ausente",Close:Close$3,"Close emoji picker":"Fechar seletor de emoji","Commands matching":"Correspondência de comandos","Connection failure, reconnecting now...":"Falha de conexão, reconectando agora ...",Delete:Delete$3,Delivered:Delivered$3,"Edit Message":"Editar Mensagem","Emoji matching":"Emoji correspondente","Empty message...":"Mensagem vazia ...","Error adding flag: Either the flag already exist or there is issue with network connection ...":"Erro ao adicionar sinalizador: o sinalizador já existe ou há um problema com a conexão de rede ...","Error connecting to chat, refresh the page to try again.":"Erro ao conectar ao bate-papo, atualize a página para tentar novamente.","Error muting a user ...":"Erro ao silenciar um usuário ...","Error pinning message":"Erro ao fixar mensagem","Error removing message pin":"Erro ao remover o PIN da mensagem","Error unmuting a user ...":"Erro ao ativar o som de um usuário ...","Error · Unsent":"Erro · Não enviado","Error: {{ errorMessage }}":"Erro: {{errorMessage}}",Flag:Flag$3,"Message Failed · Click to try again":"A mensagem falhou · Clique para tentar novamente","Message Failed · Unauthorized":"A mensagem falhou · não autorizado","Message deleted":"Mensagem apagada","Message has been successfully flagged":"A mensagem foi sinalizada com sucesso","Message pinned":"Mensagem fixada",Mute:Mute$3,New:New$3,"New Messages!":"Novas mensagens!","Nothing yet...":"Nada ainda...","Only visible to you":"Visível apenas para você","Open emoji picker":"Abrir seletor de emoji","People matching":"Pessoas combinando","Pick your emoji":"Escolha o seu emoji",Pin:Pin$3,"Pinned by":"Fixado por",Send:Send$3,"Sending...":"Enviando ...","Start of a new thread":"Início de um novo tópico","This message was deleted...":"Esta mensagem foi excluída ...",Thread:Thread$4,"Type your message":"Digite sua mensagem",Unmute:Unmute$3,Unpin:Unpin$3,"You have no channels currently":"Você não tem canais atualmente","You've reached the maximum number of files":"Você atingiu o número máximo de arquivos",live:live$3,"this content could not be displayed":"este conteúdo não pôde ser exibido","{{ commaSeparatedUsers }} and {{ lastUser }} are typing...":"{{commaSeparatedUsers}} e {{lastUser}} estão digitando ...","{{ commaSeparatedUsers }} and {{ moreCount }} more":"{{commaSeparatedUsers}} e mais {{moreCount}}","{{ commaSeparatedUsers }}, and {{ lastUser }}":"{{commaSeparatedUsers}} e {{lastUser}}","{{ firstUser }} and {{ secondUser }}":"{{firstUser}} e {{secondUser}}","{{ firstUser }} and {{ secondUser }} are typing...":"{{firstUser}} e {{secondUser}} estão digitando ...","{{ imageCount }} more":"{{imageCount}} mais","{{ memberCount }} members":"{{memberCount}} membros","{{ replyCount }} replies":"{{replyCount}} respostas","{{ user }} has been muted":"{{user}} foi silenciado","{{ user }} has been unmuted":"{{user}} foi reativado","{{ user }} is typing...":"{{user}} está digitando ...","{{ watcherCount }} online":"{{watcherCount}} online","🏙 Attachment...":"🏙 Anexo ..."};
...
var Streami18n = /** @class */ (function () {
    ...
    function Streami18n(options) {
        ...
        this.translations = {
            ...
            es: (_b = {}, _b[defaultNS] = esTranslations, _b),
            fr: (_c = {}, _c[defaultNS] = frTranslations, _c),
            hi: (_d = {}, _d[defaultNS] = hiTranslations, _d),
            it: (_e = {}, _e[defaultNS] = itTranslations, _e),
            nl: (_f = {}, _f[defaultNS] = nlTranslations, _f),
            pt: (_g = {}, _g[defaultNS] = ptTranslations, _g),
            ru: (_h = {}, _h[defaultNS] = ruTranslations, _h),
            tr: (_j = {}, _j[defaultNS] = trTranslations, _j),
        };
        /**
        ...
        if (translationsForLanguage) {
            this.translations[this.currentLanguage] = (_k = {},
                _k[defaultNS] = translationsForLanguage,
                _k);
        }
        // If translations don't exist for given language, then set it as empty object.
        if (!this.translations[this.currentLanguage]) {
            this.translations[this.currentLanguage] = (_l = {},
                _l[defaultNS] = {},
                _l);
        }
        this.i18nextConfig = {
...
var processMessages = function (messages, lastRead, userID, hideDeletedMessages, disableDateSeparator, hideNewMessageSeparator) {
    var _a, _b, _c;
    var unread = false;
...
var UnMemoizedMessageListInner = function (props) {
    ...
    var enrichMessages = function () {
        var messageWithDates = threadList || (disableDateSeparator && !hideDeletedMessages && hideNewMessageSeparator)
            ? messages
...
var VirtualizedMessageListWithContext = function (props) {
    ...
    var processedMessages = useMemo(function () {
        ...
        return processMessages(messages, lastRead, userID, hideDeletedMessages, disableDateSeparator, hideNewMessageSeparator);
    }, [
        disableDateSeparator,
        hideDeletedMessages,

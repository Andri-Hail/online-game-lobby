...
exports.EditMessageForm = void 0;
...
var EditMessageForm = function (_React$Component) {
  (0, _inherits2.default)(EditMessageForm, _React$Component);
  ...
  function EditMessageForm() {
    ...
    (0, _classCallCheck2.default)(this, EditMessageForm);
  ...
  (0, _createClass2.default)(EditMessageForm, [{
    key: "render",
    value: function render() {
      ...
      }, this.renderEmojiPicker(), this.renderUploads(), this.props.emojiPickerIsOpen && _react.default.createElement("div", {
...
(0, _defineProperty2.default)(EditMessageForm, "propTypes", {
...
(0, _defineProperty2.default)(EditMessageForm, "defaultProps", {
  grow: true,
  focus: false,
  disabled: false
});
exports.EditMessageForm = EditMessageForm = (0, _context.withTranslationContext)(EditMessageForm);
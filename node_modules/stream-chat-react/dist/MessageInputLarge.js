...
exports.MessageInputLarge = void 0;
...
var MessageInputLarge = function (_PureComponent) {
  (0, _inherits2.default)(MessageInputLarge, _PureComponent);

  var _super = _createSuper(MessageInputLarge);

  function MessageInputLarge() {
    var _this;

    (0, _classCallCheck2.default)(this, MessageInputLarge);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "constructTypingString", function (dict) {
      var t = _this.props.t;
  ...
  (0, _createClass2.default)(MessageInputLarge, [{
    key: "render",
...
(0, _defineProperty2.default)(MessageInputLarge, "propTypes", {
...
var MessageInputLargeWithContext = (0, _context.withTranslationContext)(MessageInputLarge);

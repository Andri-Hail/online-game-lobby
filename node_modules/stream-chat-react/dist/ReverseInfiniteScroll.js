...
exports.ReverseInfiniteScroll = void 0;
...
var ReverseInfiniteScroll = function (_Component) {
  (0, _inherits2.default)(ReverseInfiniteScroll, _Component);

  var _super = _createSuper(ReverseInfiniteScroll);

  function ReverseInfiniteScroll(props) {
    var _this;

    (0, _classCallCheck2.default)(this, ReverseInfiniteScroll);
  ...
  (0, _createClass2.default)(ReverseInfiniteScroll, [{
    ...
    value: function render() {
      ...
      var children = renderProps.children,
          ...
          props = (0, _objectWithoutProperties2.default)(renderProps, ["children", "element", "hasMore", "initialLoad", "isReverse", "loader", "loadMore", "pageStart", "ref", "threshold", "useCapture", "useWindow", "listenToScroll", "isLoading"]);
...
(0, _defineProperty2.default)(ReverseInfiniteScroll, "propTypes", {
  ...
  listenToScroll: _propTypes.default.func
});
(0, _defineProperty2.default)(ReverseInfiniteScroll, "defaultProps", {
  element: 'div',
  hasMore: false,
  initialLoad: true,
  pageStart: 0,
